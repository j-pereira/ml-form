const config = { 
    schools: {
        romantism: {
            title: 'Romantismo', 
            description: 'O Romantismo foi um movimento artístico que surgiu na Europa no século XVIII e durou até meados do século XIX. Na literatura, as características mais marcantes deste movimento são: a exaltação do nacionalismo, da natureza e da pátria; a idealização da sociedade, do amor e da mulher; o sentimentalismo e supervalorização das emoções pessoais; o subjetivismo e egocentrismo; as saudades da infância, e fuga da realidade.|As mulheres no romantismo tiveram um papel importante para o desenvolvimento literário. Elas eram consideradas seres intocáveis e faziam parte de um universo de ilusões dos eternos apaixonados. A virgindade e o sensualismo também eram bastante valorizados nas obras românticas. Tanto em pinturas quanto na literatura da época, muitas heroínas eram moças virgens e frágeis.|Com o passar do tempo, o modelo de mulher graciosa, delicada, bela e, em resumo, perfeita, continuou sendo utilizado e está presente em muitas manifestações culturais contemporâneas, e até mesmo dentro das mulheres que ainda carregam estes valores.'
        }, 
        realism: {
            title: 'Realismo', 
            description: 'O Realismo foi um movimento artístico que teve início no final do século XIX e tinha como principais características a ambientação da história em cenários urbanos e sociais; a temática social e cotidiana; críticas à realidade, à sociedade da época e os valores burgueses; a representação mais fiel da realidade; oposição ao romantismo; personagens comuns e sem idealização, e a veracidade e contemporaneidade da obra.|As mulheres realistas eram retratadas como seres não idealizados, mais condizentes com a realidade, que possuíam defeitos e uma personalidade concreta. As mulheres desse período também começaram a ser vistas com desejo pelos homens e o amor e o casamento, os quais eram elementos de felicidade no período anterior, transformaram-se em meras convenções sociais de aparência.|Os autores deste período buscavam retratar a realidade de forma crua, sem fantasias e subjetividade. Por conta disso, as mulheres descritas nesse período literário, com seus anseios e defeitos, mostram-se mais semelhantes à nossa realidade atual.'
        }, 
        nda: {
            title: '', 
            description: ''
    ...
    books: {
        ...
        nda: {
            woman: '',
            title: 'Você não se encaixa em nenhum dos perfis estudados',
            part: '“Ninguém nasce mulher: torna-se mulher. Nenhum destino biológico, psíquico, econômico define a forma que a fêmea humana assume no seio da sociedade.” (BEAUVOIR, 2016)',
            description: 'Calma, isso pode ser algo muito bom!|O intuito desta entrevista é descobrir se houveram avanços desde o século XIX na vida das mulheres. Para isso, foram utilizados dez perfis femininos retirados de dez obras literárias publicadas entre 1842 e 1899, ou seja, cerca de cento e cinquenta anos atrás.|Se você não se encaixa em nenhum desses perfis, isso significa que você provavelmente já conseguiu se desvencilhar dos padrões antigos que infelizmente ainda se mostram presentes na vida das mulheres.|Desejo que você possa viver sua vida da forma que bem entender, desde que isso lhe traga felicidade <3',
            school: 'nda'
        },
        nsco: {
            woman: 'NSCO',
    ...
    [
        {
            title: '1.  Como você reagiria diante de um casamento forçado, ou de permanecer a força em um casamento que não te faz feliz?',
            alternatives: [
                {
                    option: 'a) Choraria muito e deixaria todos pensarem que você estava de acordo, mas fugiria às vésperas do casamento.',
                ...
                {
                    option: 'd) Lutaria até o fim para evitar que isso acontecesse, mas caso falhasse, tentaria a todo custo manter sua dignidade.',
                    value: 'luciola'
                },
                {
                ...
                {
                    option: 'h) Nenhuma das Anteriores',
                    value: 'nda'
                }
            ]
        },
        {
            title: '2.  O que é o casamento pra você?',
            alternatives: [
                {
                    option: 'a) A junção, segundo a lei de Deus e dos homens, de duas almas que se amam.',
                    value: 'bruxa_monte_cordova'
                },
                {
                ...
                {
                    option: 'd) Você tenta ao máximo ser dona de seu próprio destino, e por isso rejeita imposições sociais, mas no fundo deseja ser amada e cuidada por um homem, e o casamento é a realização máxima disso.',
                    value: 'luciola'
                },
                {
                    option: 'e) Vê no casamento uma injustiça e uma tortura.',
                    value: 'mulher_30_anos'
                },
                {
                    option: 'f) Uma prisão, principalmente quando realizado com um homem que não sabe aproveitar a vida. Além disso, não é um meio para alcançar a felicidade amorosa.',
                    value: 'madame_bovary'
                },
                {
                    option: 'g) Meio de ascensão social, mas não necessariamente onde se encontra o amor.',
                    value: 'mem_pos_bras_cubas'
                },
                {
                    option: 'h) Sonho doce, mas não inabalável. Pequena prisão, mas nada grave se houver amor.',
                    value: 'primo_basilio'
                },
                {
                    option: 'i) Status social e realização pessoal.',
                    value: 'dom_casmurro'
                },
                {
                    option: 'j) A sociedade impõe que casar-se é algo maravilhoso para uma mulher, mas você sabe que não é bem assim, e que o contrário pode ser real.',
                    value: 'quincas_borba'
                },
                {
                    option: 'k) Nenhuma das Anteriores',
                    value: 'nda'
                }
        ...
        },
        {
            ...
            alternatives: [
                ...
                {
                    option: 'd) Um fardo, principalmente quando vinda através de um homem que não se ama.',
                    value: 'mulher_30_anos'
                },
                {
                    option: 'e) Um tormento, impedimento para plenitude de sua felicidade pessoal. Não é possível conciliar uma vida de liberdade e aventuras com as exigências de ter um filho.',
                    value: 'madame_bovary'
                },
                {
                ...
                {
                    option: 'g) Um sonho doce, companhia para a mãe, desejo de toda mulher.',
                    value: 'primo_basilio'
                },
                {
                ...
                {
                    option: 'i) Não se faz importante para a felicidade pessoal e do matrimônio.',
                    value: 'quincas_borba'
                },
                {
                    option: 'j) Nenhuma das Anteriores',
                    value: 'nda'
                }
            ]
        },
        {
            ...
            alternatives: [
                ...
                {
                    option: 'b) As mulheres não devem resignarem-se com os papéis que a sociedade lhes impõe e devem sempre lutar por aquilo que acreditam. No entanto, é necessário saber ponderar e entender que alguns sacrifícios precisarão ser feitos em nome da moral.',
                    value: 'doida_candal'
                },
                {
                ...
                {
                    option: 'e) Você vê que a sociedade cobra das mulheres uma atitude de submissão e inferioridade. Isso te causa sofrimento intenso, mas você não desiste de criticá-la insistentemente.',
                    value: 'mulher_30_anos'
                },
                {
                    option: 'f) Percebe que homens possuem mais direitos que as mulheres, não só os garantidos por lei, mas os que são socialmente convencionados. Você sente repulsa dessa situação, mas não sabe o que fazer para sair dela.',
                    value: 'madame_bovary'
                },
                {
                ...
                {
                    option: 'h) Você quer viver da forma que suas emoções mandam, mas sabe que a sociedade não tolera uma mulher dessa forma. Isso a faz, em alguma medida, sofrer.',
                    value: 'primo_basilio'
                },
                {
        ...
        {
            title: '5.  Numa escala de um a dez, quanto você diria que a religião interfere na sua vida?',
            alternatives: [
                {
                    option: '1',
                    value: 'quincas_borba'
        ...
        },
        {
            ...
            alternatives: [
                ...
                {
                    option: 'b) Se a mulher não for a parte comprometida, ela é livre para viver da forma que desejar.',
                    value: 'luciola'
                },
                {
                ...
                {
                    option: 'd) Um meio de alcançar a tão desejada paixão, o êxtase e a felicidade.',
                    value: 'madame_bovary'
                },
                {
                ...
                {
                    option: 'f) Sinônimo de liberdade, aventura, de estar viva, já que a vida de uma mulher é tão cheia de regras.',
                    value: 'primo_basilio'
                },
                {
                    option: 'g) O adultério é a quebra de confiança, independentemente de traições físicas e fazê-lo uma vez ou outra é aceitável.',
                    value: 'dom_casmurro'
                },
                {
                    option: 'h) Como mulher comprometida, você não se sente bem ao receber propostas de outros homens/mulheres, entretanto, isso não impede que esses interesses inflem seu ego e sua vaidade. ',
                    value: 'quincas_borba'
                },
                {
                    option: 'i) Nenhuma das Anteriores',
                    value: 'nda'
                }
            ]
        },
        {
            ...
            alternatives: [
                ...
                {
                    option: 'c) O amor é a essência da vida. Quando se ama a pessoa com que se convive, toda a vida se faz boa. O relacionamento com o homem que se ama deve ser de submissão, cuidado e carinho.',
                    value: 'viuvinha'
                },
                {
        ...
        },
        {
            ...
            alternatives: [
                ...
                {
                    option: 'h) A felicidade conjugal é a maior parte da felicidade de uma mulher, mas isso não descarta a possibilidade de existir outros atrativos que também a façam feliz.',
                    value: 'primo_basilio'
                },
                {
                    option: 'i) É parte de sua felicidade, mas você não se reduz ou se submete àquilo que lhe faz mal para tê-lo.',
                    value: 'dom_casmurro'
                },
                {
                    option: 'j) Nenhuma das Anteriores',
        ...
        {
            title: '9.  Em sua visão, qual o papel da mulher em relação aos serviços domésticos?',
            alternatives: [
                {
                    option: 'a) Somente a mulher tem a capacidade e o dever de realizar as tarefas domésticas da forma correta.',
                ...
                {
                    option: 'c) Os serviços domésticos devem ser delegados a empregados.',
                    value: 'primo_basilio|mem_pos_bras_cubas|quincas_borba'
                },
                {
                    option: 'd) Homens e mulheres devem dividir igualmente os serviços domésticos, uma vez que os dois vivem na mesma casa.',
                    value: 'dom_casmurro|madame_bovary|mulher_30_anos'
                },
                {
        ...
        },
        {
            ...
            alternatives: [
                ...
                {
                    option: 'i) Não. Você acredita que a mulher deve impor-se fortemente e defender suas vontades e pontos de vista, mas aceita coisas que considera pequenas para o bem estar da relação.',
                    value: 'dom_casmurro'
                },
                {
                    option: 'j) A mulher tem sua independência moral, intelectual e emocional e deve fazer uso dela – preferencialmente sem alertar o homem com quem convive para não perder essa liberdade.',
                    value: 'quincas_borba'
                },
                {
                    option: 'k) Nenhuma das Anteriores',
        ...
        },
        {
            ...
            alternatives: [
                ...
                {
                    option: 'b) Não. Homens são seres completos e irredutíveis.',
                    value: 'doida_candal'
                },
                {
                ...
                {
                    option: 'd) Não é papel da mulher, uma vez que os homens são ensinados a serem como são pela sociedade.',
                    value: 'mulher_30_anos'
                },
                {
                    option: 'e) Por mais que tente, ninguém tem a capacidade de mudar o outro.',
                    value: 'madame_bovary'
                },
                {
                    option: 'f) É possível se houver amor verdadeiro.',
                    value: 'primo_basilio'
                },
                {
                    option: 'g) A sociedade acredita que sim, mas você não sente que é seu dever fazê-lo.',
                    value: 'dom_casmurro'
                },
                {
                    option: 'h) Sim, no entanto, isso não é sua obrigação.',
                    value: 'quincas_borba'
                },
                {
                    option: 'i) Nenhuma das Anteriores',
        ...
        {
            title: '12.    O que você acha de uma mulher que toma suas próprias decisões e segue sua vida sem se importar com opiniões alheias?',
            alternatives: [
                {
                    option: 'a) Impensável. Faltar com as obrigações sociais é um escândalo e um pecado grave.',
                    value: 'bruxa_monte_cordova'
                },
                {
                    option: 'b) Todas as mulheres deveriam ser fortes, independentes e livres e é injusto que a sociedade recrimine a mulher que vive da forma que bem entender.',
                    value: 'doida_candal'
                },
                {
                ...
                {
                    option: 'd) A mulher deve escolher entre sua liberdade e ser socialmente aceita, não é possível manter os dois.',
                    value: 'luciola'
                },
                {
                ...
                {
                    option: 'f) A mulher que sonha, ama e deseja, deve correr atrás de satisfazer-se e ser feliz, nem que para isso seja necessário ir contra a sociedade e a moral. As mulheres que assim vivem estão apenas tentando encontrar sua felicidade.',
                    value: 'madame_bovary'
                },
                {
                    option: 'g) Você acha que toda mulher tem direito a viver da forma que bem entender, mas tem medo das consequências sociais e morais que isso pode acarretar.',
                    value: 'mem_pos_bras_cubas'
                },
                {
                ...
                {
                    option: 'i) São fortes e inteligentes, e devem ter sua individualidade respeitada.',
                    value: 'dom_casmurro'
                },
                {
        ...
        {
            title: '13.   Você acha que a partir dos quinze anos, a menina já pode ser considerada mulher?',
            alternatives: [
                {
                    option: 'a) Concordo plenamente.',
                    value: 'bruxa_monte_cordova|viuvinha'
                },
                {
                    option: 'b) Concordo parcialmente.',
                    value: 'doida_candal|luciola'
                },
                {
                    option: 'c) Indiferente.',
                    value: 'madame_bovary|quincas_borba'
                },
                {
                    option: 'd) Discordo parcialmente.',
                    value: 'dom_casmurro|mem_pos_bras_cubas|mulher_30_anos'
                },
                {
                    option: 'e) Discordo totalmente.',
                    value: 'primo_basilio'
                },
                {
                    option: 'f) Não tenho opinião formada',
                    value: 'nda'
                },
            ]
        },
        {
            ...
            alternatives: [
                ...
                {
                    option: 'b) Uma mulher deve saber se valorizar e se manter fiel a sua autoestima, amor próprio, vaidade, honra e valores. A reputação deve vir em segundo plano – sem deixar de ser importante. Além disso, aquela que sofre para fazer feliz àqueles que ama assemelha-se a uma heroína.',
                    value: 'doida_candal'
                },
                {
                ...
                {
                    option: 'd) É ser pura ainda que na volúpia. É manter a inocência de seu coração e alma, ainda que o mundo corrompa seu corpo e imagem.',
                    value: 'luciola'
                },
                {
                ...
                {
                    option: 'f) Ser mulher é sonhar, querer e não poder, e ao final de tudo, sentir-se triste, infeliz e amargurada por não ter conseguido tornar sua felicidade.',
                    value: 'madame_bovary'
                },
                {
                    option: 'g) É ser imperfeita, mas saber tirar daí seu charme e sensualidade. Também é ser astuta, misteriosa e provocante, ainda que de forma velada.',
                    value: 'mem_pos_bras_cubas'
                },
                {
                    option: 'h) Ser feminina: estar sempre bonita, arrumada, bem cuidada.',
                    value: 'primo_basilio'
                },
                {
                ...
                {
                    option: 'j) É ser inteligente e ambiciosa, e utilizar-se friamente de suas armas naturais – beleza e vaidade – para alcançar o que deseja.',
                    value: 'quincas_borba'
                },
                {
                    option: 'k) Nenhuma das Anteriores.',
        ...
        {
            title: '15.   Qual sua opinião sobre mulheres que expressam seus desejos sexuais?',
            alternatives: [
                {
                    option: 'a) Um escândalo impensável. A sexualidade de uma mulher deve se manter entre quatro paredes. O sexo é uma obrigação conjugal.',
                    value: 'bruxa_monte_cordova'
                },
                {
                    option: 'b) Você não nega que uma mulher tenha tanto desejo sexual quanto um homem, mas não acha por bem expressá-los.',
                    value: 'doida_candal'
                },
                {
                    option: 'c) São consideradas objetos.',
                    value: 'luciola'
                },
                {
                    option: 'd) Todas as mulheres possuem desejos ferozes que devem ser reprimidos.',
                    value: 'mulher_30_anos'
                },
                {
                ...
                {
                    option: 'g) As mulheres são, naturalmente, seres que não devem ser expostas a esse tipo de expressão. A sexualidade de uma mulher é particular ao seu parceiro.',
                    value: 'primo_basilio'
                },
                {
                    option: 'h) Não tenho opinião formada sobre o assunto.',
                    value: 'dom_casmurro'
                },
                {
                    option: 'i) Perdem seu valor perante a sociedade. Uma mulher deve manter-se “nos eixos” para ser respeitada. No entanto, você não nega que todas as mulheres tenham desejos ardentes.',
                    value: 'quincas_borba'
                },
                {
                    option: 'j) Nenhuma das Anteriores',
        ...
        {
            title: '16.    Você acha que, no fundo, a mulheres querem ser cuidadas por homens?',
            alternatives: [
                {
                    option: 'a) É o desejo de toda mulher, além de ser necessário que elas sejam cuidadas e tuteladas.',
                    value: 'bruxa_monte_cordova'
                },
                {
                ...
                {
                    option: 'c) Indiscutivelmente sim. Nenhuma mulher pode ser inteiramente feliz sem um homem que cuide de todos os aspectos de sua vida.',
                    value: 'viuvinha'
                },
                {
                ...
                {
                    option: 'f) Sim e não. As mulheres desejam liberdade, mas ter um homem ao seu lado traz aventuras, paixões e, de certa forma, segurança.',
                    value: 'madame_bovary'
                },
                {
                ...
                {
                    option: 'i) Não. Somos suficientemente fortes para querer, ao invés de precisar dos homens.',
                    value: 'dom_casmurro'
                },
                {
                    option: 'j) Existem coisas das quais não conseguimos nos proteger sozinhas e por isso é importante ter um parceiro que cuide de nós. Isso não se aplica a todas as esferas de nossas vidas.',
                    value: 'quincas_borba'
                },
                {
                    option: 'k) Nenhuma das Anteriores',
        ...
        {
            title: '17.   Qual das alternativas abaixo melhor descreve uma mulher de mais de trinta anos?',
            alternatives: [
                {
                    option: 'a) Aos trinta anos a mulher já deve ter alcançado todos os seus principais objetivos na vida: casar-se, ter filhos e constituir uma família feliz. Deve ser uma senhora de respeito.',
                    value: 'bruxa_monte_cordova|doida_candal'
                },
                {
                    option: 'b) São mulheres que já viveram o que poderiam viver e por isso não merecem mais a atenção da sociedade.',
                    value: 'viuvinha'
                },
                {
                    option: 'c) Você vê que a sociedade julga as mulheres mais velhas como seres que já viveram e agora servem para passar conhecimento e experiência às mais jovens.',
                    value: 'mulher_30_anos'
                },
                {
                    option: 'd) A partir de uma certa idade a mulher passa a ter uma beleza diferente daquela que tinha quando jovem.',
                    value: 'mem_pos_bras_cubas'
                },
                {
                    option: 'e) Amarguradas por não terem mais seus anos dourados de volta.',
                    value: 'primo_basilio'
                },
                {
                    option: 'f) São mulheres que vivem única e exclusivamente para sua família.',
                    value: 'dom_casmurro'
                },
                {
                    option: 'g) Algumas mulheres só alcançam sua beleza e perfeição máxima perto ou após os trinta anos.',
                    value: 'quincas_borba'
                },
                {
                    option: 'h) Nenhuma das Anteriores',
